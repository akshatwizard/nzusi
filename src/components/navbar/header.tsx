            ...
            >
                <nav className='relative w-full max-w-7xl mx-auto flex items-center py-3 h-full gap-1.5'>
                    ...
                    <div className='max-md:flex-1 relative flex items-center justify-end gap-2 h-full'>
                        <button
                            onClick={() => isAuthenticated ? setShowOptions(prev => !prev) : setIsLoginOpen(true)}
                    ...
                    <AnimatePresence>
                        {showOptions && user && (
                            <motion.div
                                ref={dropdownRef}
                                className="absolute z-20 mt-2 top-full right-0 p-4 min-w-60 max-w-64 bg-white backdrop-blur-xl rounded-2xl shadow-xl border border-gray-200 space-y-5"
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-1">
                                    <motion.button
                                        ...
                                        onClick={() => router.push(`/profile/${user?.customer_id}`)}
