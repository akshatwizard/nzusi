    ...
    >
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          <span
            className={`text-[10px] font-bold px-2.5 py-1 rounded-full border ${cat.color}`}
          >
            {cat.code}
          </span>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl text-fun-blue-950 leading-tight">
                  Scientific{" "}
                  <em className="not-italic text-fun-blue-400">Abstracts</em>
                </h2>
                ...
                <div className="flex items-center gap-4 px-5 py-3 bg-white rounded-2xl border border-zinc-200 shadow-sm">
                  {CATEGORIES.map((c, i) => (
                    <div key={c.id} className="flex flex-col items-center">
                      <span className="text-xl font-bold text-fun-blue-950 tabular-nums">
                        {c.count}
                      </span>
